                ...
                <?php while ($jobs_query->have_posts()): $jobs_query->the_post(); ?>
                    <a href="<?php the_permalink(); ?>" class="block p-10 bg-white">
                        <article class="flex flex-col">
                            ...
                            <span class="self-start px-12 mt-6 text-base text-white uppercase bg-primary min-h-[60px] flex items-center justify-center max-md:px-5 font-semibold border-2 border-[#0D783D] hover:bg-transparent hover:text-[#0D783D]">Read more</span>
                        </article>
                    </a>
                <?php endwhile;
                wp_reset_postdata(); ?>
