...
<?php if ($hero_002_show_icon_boxes && $hero_002_icon_boxes) : ?>
  <section class="w-full py-12 mx-auto section_icon_boxes bg-gray-50 max-w-container">
    <div class="px-4 mx-auto">
      <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        ?>
          <div class="flex-col <?php echo esc_attr($hero_002_bg_color); ?> p-6 rounded-lg flex items-center">
            <div class="mx-4 mt-6">
            ...
            <div class="counter_column">
              <h3 class="text-2xl leading-none tracking-tight text-white"><?php echo esc_html($hero_002_title); ?></h3>
              <p class="mt-2 text-base leading-6 text-zinc-100"><?php echo esc_html($hero_002_text); ?></p>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
